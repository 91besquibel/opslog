...
public class Settings {
    ...
    public static ObjectProperty<Background> rootBackground =
            new SimpleObjectProperty<>(
                    new Background(
                            new BackgroundFill(rootColor.get(), CORNER_RADII, INSETS_ZERO)));

    public static ObjectProperty<Background> primaryBackground =
            new SimpleObjectProperty<>(
                    new Background(
                            new BackgroundFill(primaryColor.get(), CORNER_RADII, INSETS_ZERO)));

    public static ObjectProperty<Background> secondaryBackground =
            new SimpleObjectProperty<>(
                    new Background(
                            new BackgroundFill(secondaryColor.get(), CORNER_RADII, INSETS_ZERO)));
    ...
    public static ObjectProperty<Background> selectedBackground =
            new SimpleObjectProperty<>(
                    new Background(
                            new BackgroundFill(selectedColor.get(), CORNER_RADII, INSETS_ZERO)));
