...
public class Settings{
	...
	// Listener
	static {
		focusColor.addListener((obs, oldColor, newColor) -> {updateBorderFocus();});
		rootColor.addListener((obs, oldColor, newColor) -> {updateRootBackground();});
		primaryColor.addListener((obs, oldColor, newColor) -> {updatePrimaryBackground();});
		secondaryColor.addListener((obs, oldColor, newColor) -> {updateSecondaryBackground();});
