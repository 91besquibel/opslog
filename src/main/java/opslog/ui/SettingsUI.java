...
public class SettingsUI{
	...
	private static VBox createPathCard(){
		...
		mpathSwap.setOnAction(event -> {
			if(mpathSelector.getValue() != null){Directory.initialize(mpathSelector.getValue());}
			else{showPopup("Settings: Change Path", "Path selector empty, please select a choice");}
		});
