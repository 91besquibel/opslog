...
import opslog.ui.settings.managers.*;
import opslog.ui.calendar.CalendarLayout;
...
public class ScheduledTaskManager{
	...
	// updates the scheduledTask in the database
	...
	// adds a scheduledtask to the map based on its fid
	...
	// retrieves a scheduledTask from the refrence map
	...
	// updates a scheduledTask in the refrence map 
	...
	// Checks if the interval values are filled to schedule the task
	...
	// Used to generate the UUID for associating tasks
	public static String generateUUID() {
		return UUID.randomUUID().toString();
	}

	// Loads the intial data
